...
public class FirefoxC {
  ...
  /*    driver.manage().window().maximize();
	 ...
	 // driver.get("https://www.flipkart.com/");*/
	  System.out.println("FirefoxC webdriver initiate");
     //return driver;
	 }
@Test(priority=1)

    public void printSomethingFunc() {
    	System.out.println("FirefoxC successfully launched");
    }
@Test(priority=2)
    public void closeDriverFunc() throws InterruptedException {
    	
    	driver.close();
    	System.out.println("FirefoxC driver successfully closed ");
